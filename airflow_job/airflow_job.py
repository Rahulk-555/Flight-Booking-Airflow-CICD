...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-gds555")
    bq_project = Variable.get("bq_project", default_var="bustling-shape-455618-d4")
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="bustling-shape-455618-d4",
        region="us-central1",
